...
const FriendlyPlant = ({ friendlyPromise }) => {

    const friendlyData = use(friendlyPromise);
        console.log(friendlyData);
    
    
        return (
            <div className='py-8 mt-12'>
                <h2 className="text-2xl font-bold mb-6 text-center">🌿 Beginner-Friendly Plants</h2>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr w-9/12 mx-auto'>
                    {
                       friendlyData.map((item, index) => (
